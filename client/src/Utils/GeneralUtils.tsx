...
export const getAllFinishedProfiles = async () => {
  const res = await axios.get(
    "https://www.api.rituale.digital/all-finished-profiles"
  )
  return res.data
}
...
export const getAllCompletedHabits = async () => {
  const res = await axios.get(
    "https://www.api.rituale.digital/all-completed-habits"
  )
  return res.data
}

export const getAllBlogs = async () => {
  const res = await axios.get("https://www.api.rituale.digital/all-blogs")
  return res.data
}
...
export const handleAddBlog = (e: React.FormEvent, blogData: BlogDataTypes) => {
  ...
  axios.post(
    "https://www.api.rituale.digital/add-blog",
...
export const handleBlogDelete = (id: number) => {
  axios.delete("https://www.api.rituale.digital/remove-blog", {
